...
class PluginsSliderController extends CommonController {
   	protected function _initialize(){
		...
		if($this->system_hide_wepro)
		{//隐藏小程序，显示服务号
			$this->type_config = array(
				'index_ad_nav' => '首页导航',
				'index_ad_head' => '首页滚动广告',
				'index_ad_list' => '首页横条广告',
				'index_wepro_line' => '首页横条广告(2图)',

				'pin_index_ad' =>'拼团首页广告',
				'lottery_wepro_head' =>'抽奖团广告',
				'newman_wepro_head' =>'老带新广告',
				'wepro_integral_mall' => '积分商城顶部广告',
				'wepro_bargain_ad' => '砍价顶部广告',
			);
		}
		if($this->system_hide_dan)
		{//隐藏服务号，显示小程序
			$this->type_config = array(
